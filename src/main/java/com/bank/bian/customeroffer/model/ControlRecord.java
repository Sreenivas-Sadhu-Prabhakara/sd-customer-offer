package com.bank.bian.customeroffer.model;
...
/**
 * The BIAN control record for this service domain: "Customer Offer Management Plan".
 *
 ...
 * to its asset type (Customer Offer). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Customer Offer Management Plan";
